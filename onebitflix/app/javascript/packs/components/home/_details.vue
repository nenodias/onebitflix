  ...
  <v-layout row wrap>
    <v-flex md4 mb-3 mt-2 offset-md1 xs10 offset-xs1>
      ...
      <v-layout row wrap mt-3>
        ...
        <v-flex md6 pt-2 pl-2>
          <v-icon
            v-for="r in watchable.attributes.reviews_count"
            :key="r"
            color="red"
            >favorite</v-icon
          >
          <v-icon
            v-for="r in 5 - watchable.attributes.reviews_count"
      ...
      <v-layout row wrap mt-4>
        ...
        <v-flex sm3 md4>
          <v-btn color="black" class="watch-btn white--text" large
            >+ Minha Lista</v-btn
          >
        </v-flex>
      </v-layout>
    ...
    <v-flex md5 offset-md1 hidden-sm-and-down>
      <v-layout row wrap mt-12 center xs-10>
        <img
          :src="watchable.attributes.thumbnail_cover_url"
